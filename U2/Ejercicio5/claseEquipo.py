class Equipo:
    ...
    def __gt__(self, otro_equipo):
        if self.__puntos != otro_equipo.__puntos:
            return self.__puntos < otro_equipo.__puntos
        elif self.__diferenciaGoles != otro_equipo.__diferenciaGoles:
            return self.__diferenciaGoles < otro_equipo.__diferenciaGoles
        else:
            return self.__golesFavor < otro_equipo.__golesFavor
